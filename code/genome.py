...
class Genome():
    ...
    def update_hash(self):
        ...
        genh = str(self.geneparam['filter']) + str(self.geneparam['filter1']) + str(self.geneparam['filter2']) + str(self.geneparam['filter3'])\
               + str(self.geneparam['kernel_size']) + str(self.geneparam['kernel_size1']) + str(self.geneparam['kernel_size2']) \
               + str(self.geneparam['kernel_size3']) + str(self.geneparam['activation']) + str(self.geneparam['lr']) + str(self.geneparam['dropout'])\
               + str(self.geneparam['batch_size']) + str(self.geneparam['epoch']) + str(self.geneparam['layer_size'])\
               + str(self.geneparam['lstm_units']) + str(self.geneparam['lstm_units1']) + str(self.geneparam['layer_size1'])
